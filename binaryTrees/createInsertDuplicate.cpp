...
BTNode<int> * createInsert(BTNode<int>* root){
    if(root == NULL) return NULL;

    BTNode<int>* newNode = new BTNode<int>(root->data);
    BTNode<int>* leftTree = createInsert(root->left);
    BTNode<int>* rightTree = createInsert(root->right);
